export default class GameSetting extends Phaser.Scene {
  ...
  create() {
    ...
    gameMenuBox.fillStyle(0x333333, 1).fillRect(120, 154, 787, 446).depth = 1;

    const gameMenuLine = this.add.graphics();
    gameMenuLine.fillStyle(0x535353, 1).fillRect(396, 154, 2, 446).depth = 2;
    ...
    easyButtonText
      ...
      .setPadding(4).depth = 3;

    easyButton.on("pointerdown", () => {
      easyButton.fillStyle(0x32b65e, 1).fillRoundedRect(585, 224, 134, 56, 30);
      this.size = "2x4";
      easyButtonText.setStyle({
        color: "#ffffff",
      });
    });
    ...
    nomalButton.on("pointerdown", () => {
      nomalButton.fillStyle(0x32b65e, 1).fillRoundedRect(585, 338, 134, 56, 30);
      this.size = "3x6";
      nomalButtonText.setStyle({
        color: "#ffffff",
      });
    });
    ...
    hardButton.on("pointerdown", () => {
      hardButton.fillStyle(0x32b65e, 1).fillRoundedRect(585, 451, 134, 56, 30);
      this.size = "4x8";
      hardButtonText.setStyle({
        color: "#ffffff",
      });
    });
    ...
    timeLimitButton.on("pointerdown", () => {
      timeLimitButton
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(585, 224, 160, 56, 30);
      this.mode = "timeLimit";
      timeLimitButtonText.setStyle({
        color: "#ffffff",
      });
    });
    ...
    timeAttackButton.on("pointerdown", () => {
      timeAttackButton
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(551, 338, 229, 56, 30);
      this.mode = "timeAttack";
      timeAttackButtonText.setStyle({
        color: "#ffffff",
      });
    });
    ...
    suddenDeathButton.on("pointerdown", () => {
      suddenDeathButton
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(573, 452, 184, 56, 30);
      this.mode = "suddenDeath";
      suddenDeathButtonText.setStyle({
        color: "#ffffff",
      });
    });
    ...
    schoolYearButton1.on("pointerdown", () => {
      schoolYearButton1
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(430, 236, 134, 56, 30);
      this.schoolYear = "1年生";
      schoolYearButton1Text.setStyle({
        color: "#ffffff",
      });
    });
    ...
    schoolYearButton2.on("pointerdown", () => {
      schoolYearButton2
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(584, 236, 134, 56, 30);
      this.schoolYear = "2年生";
      schoolYearButton2Text.setStyle({
        color: "#ffffff",
      });
    });
    // ----------------------------------------------------------------------------
    ...
    schoolYearButton3.on("pointerdown", () => {
      schoolYearButton3
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(738, 236, 134, 56, 30);
      this.schoolYear = "3年生";
      schoolYearButton3Text.setStyle({
        color: "#ffffff",
      });
    });
    // ----------------------------------------------------------------------------
    ...
    schoolYearButton4.on("pointerdown", () => {
      schoolYearButton4
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(430, 350, 134, 56, 30);
      this.schoolYear = "4年生";
      schoolYearButton4Text.setStyle({
        color: "#ffffff",
      });
    });
    // ----------------------------------------------------------------------------
    ...
    schoolYearButton5.on("pointerdown", () => {
      schoolYearButton5
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(584, 350, 134, 56, 30);
      this.schoolYear = "5年生";
      schoolYearButton5Text.setStyle({
        color: "#ffffff",
      });
    });
    // ----------------------------------------------------------------------------
    ...
    schoolYearButton6.on("pointerdown", () => {
      schoolYearButton6
        .fillStyle(0x32b65e, 1)
        .fillRoundedRect(738, 350, 134, 56, 30);
      this.schoolYear = "6年生";
      schoolYearButton6Text.setStyle({
        color: "#ffffff",
      });
    });
